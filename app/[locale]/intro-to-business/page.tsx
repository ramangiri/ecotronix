    ...
    return (
        <div className="w-full flex flex-col">
            ...
            <section className="w-full max-w-[1920px] pt-4 mx-auto px-4 md:px-4 pb-8 flex-grow flex flex-col">
                <div className="relative w-full flex-grow min-h-[600px] md:min-h-[700px]  overflow-hidden shadow-2xl">
                    {/* Background Image */}
                    ...
                    <div className="absolute inset-0 z-20 flex flex-col justify-center px-8 md:px-16 lg:px-24">
                        <div className="max-w-2xl">
                            ...
                            <Link href="/about">
                                <button className="flex items-center bg-gradient-to-r from-[#a200ff] to-[#ff007f] text-white  group hover:shadow-lg transition-all w-max p-1">
                                    <span className="px-8 py-3 text-sm font-bold tracking-wide">상세페이지로</span>
                                    <div className="bg-white text-gray-900  w-11 h-11 flex items-center justify-center group-hover:bg-gray-50 transition-colors">
