            ...
            <div className="max-w-[1920px] mx-auto px-4 md:px-8 lg:px-16">
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start gap-16">
                    ...
                    <div className="w-full">
                        ...
                        >
                            <h2
                                className="text-4xl md:text-5xl font-medium text-gray-900 mb-16"
                            >
                                주요 기술
                            </h2>
                            ...
                            <div className="space-y-12 lg:space-y-16">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-[280px_1fr] lg:grid-cols-[380px_1fr] gap-4 md:gap-8 lg:gap-12 items-start">
                                    ...
                                    <p className="text-gray-700 text-sm md:text-base leading-relaxed break-keep">
                                        라인 작업자가 직관적으로 사용할 수 있도록, 불량 체크·재판정·코멘트 입력 등을 단순 UI로 구성 관리자 화면에서는 라인별 불량 추세, <br />설비 가동률, Top 불량 유형 등을 한눈에 볼 수 있는 대시보드 제공 웹 기반 또는 로컬 전용 등 고객 환경에 맞는 배포 방식 지원
                                    </p>
                                </div>
                    ...
                    >
                        <div className=" overflow-hidden shadow-lg sticky top-32">
                            <img
