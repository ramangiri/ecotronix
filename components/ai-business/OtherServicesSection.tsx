        ...
        <section id="services" className="py-20 md:py-32 bg-[#f4f4f4]">
            <div className="mx-auto px-6 md:px-12 lg:px-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                    ...
                    <Link href="/marine-electronics" className="group cursor-pointer bg-white  overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col">
                        <motion.div
                    ...
                    <Link href="/global-ems" className="group cursor-pointer bg-white  overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col">
                        <motion.div
                            initial={{ opacity: 0, y: 30 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
