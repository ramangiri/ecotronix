                ...
                <div className="w-full max-w-[1920px] mx-auto px-4 md:px-8 lg:px-16">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                            ...
                            >
                                <div className="aspect-[4/3]  overflow-hidden mb-10 shadow-sm">
                                    <img
                    ...
                    <div className="max-w-7xl mx-auto">
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 lg:gap-6">
                            ...
                            <motion.div
                                ...
                                className="bg-white  p-8 shadow-sm flex flex-col h-full"
                            >
                                <div className="w-14 h-14 bg-[#1e6bb8]  flex items-center justify-center mb-8">
