                ...
                <div className="w-full max-w-[1920px] mx-auto px-4 md:px-8">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="flex flex-col gap-16 lg:gap-24">
                            ...
                            {/* Divider */}
                            <div className="hidden desktop-block w-full h-[1px] bg-[#5b9bd5] opacity-50"></div>
                            ...
                            >
                                ...
                                <div className="w-full lg:w-auto flex justify-center lg:justify-end lg:pr-32 relative">
                                    <div className="relative border border-[#5b9bd5] p-8 md:p-10 w-full max-w-[340px] text-gray-800 bg-transparent">
                                        ...
                                        <div className="hidden desktop-block absolute left-full top-1/2 -translate-y-1/2 w-32 h-[1px] bg-[#5b9bd5]">
                                ...
                                <div className="w-full lg:w-auto flex justify-center lg:justify-start lg:pl-32 relative">
                                    ...
                                    <div className="hidden desktop-block absolute left-0 top-1/2 -translate-y-1/2 w-16 h-[1px] bg-[#5b9bd5]"></div>
                                    ...
                                    <div className="flex flex-col gap-12 w-full max-w-[340px]">
                                        ...
                                        <div className="relative border border-[#5b9bd5] p-6 md:p-8 text-gray-800 w-full bg-transparent">
                                            ...
                                            <div className="hidden desktop-block absolute right-full top-1/2 -translate-y-1/2 w-16 h-[1px] bg-[#5b9bd5]">
                                            ...
                                            <div className="hidden desktop-block absolute right-[calc(100%+64px)] top-1/2 h-[calc(50%+24px)] w-[1px] bg-[#5b9bd5]"></div>
                                        ...
                                        <div className="relative border border-[#5b9bd5] p-6 md:p-8 text-gray-800 w-full bg-transparent">
                                            ...
                                            <div className="hidden desktop-block absolute right-[calc(100%+64px)] bottom-1/2 h-[calc(50%+24px)] w-[1px] bg-[#5b9bd5]"></div>
