                ...
                <div className="mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <motion.div
                            ...
                            className="bg-white  p-8 shadow-sm border-l-4 border-l-[#5B9BD5] relative flex flex-col h-full overflow-hidden"
                        >
                            <div className="flex items-center gap-3 mb-6">
                                <div className="w-8 h-8 rounded-full bg-[#5B9BD5] flex items-center justify-center text-white shrink-0">
                                    <Lightbulb size={16} />
                                </div>
