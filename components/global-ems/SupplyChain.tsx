...
const SupplyChain = (props: Props) => {
    return (
        <section id="trading" className="relative w-full py-24 md:py-32 overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-[1920px] mx-auto px-4 md:px-8 lg:px-16">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                        ...
                        <motion.div
                            ...
                            className="bg-white/10 backdrop-blur-md border border-white/20  p-8 md:p-10 hover:bg-white/15 transition-colors"
                        >
