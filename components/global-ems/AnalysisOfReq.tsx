...
const processTabs = [
    ...
    },
    {
        ...
        image: 'https://images.unsplash.com/photo-1590497008432-598f04441de8?q=80&w=2070&auto=format&fit=crop',
            ...
            <div className="w-full max-w-[1920px] mx-auto px-4 md:px-8 lg:px-16">
                <div className="mx-auto">
                    ...
                    <div className="flex flex-col md:flex-row items-center">
                        ...
                        >
                            <div className=" overflow-hidden border border-gray-200 p-2 bg-white shadow-sm">
                                <img
