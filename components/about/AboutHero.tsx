...
export function AboutHero() {
    return (
        <section className="w-full max-w-[1920px] mx-auto px-4 md:px-8 lg:px-16 py-8 flex flex-col">
            <div className="relative w-full flex-grow min-h-[600px] md:min-h-[700px]  overflow-hidden shadow-2xl">
                ...
                <div className="absolute inset-0 z-20 flex items-center px-8 md:px-16 lg:px-24">
                    ...
                    {/* Decorative Box */}
                    <div className="w-[350px] md:w-[450px] lg:w-[500px] h-[450px] md:h-[550px] lg:h-[600px] border border-white/40  flex-shrink-0 relative hidden md:block pointer-events-none">
                        {/* Dot */}
