            ...
            <section id="map" className="py-24">
                <div className="mb-16  px-4 sm:px-6 lg:px-24">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <span className="text-sm font-bold tracking-wider text-gray-800 uppercase">LOCATION</span>
                    </div>
                    <h2 className="text-4xl md:text-5xl font-medium text-gray-900 tracking-tight">
                        위치
                    </h2>
                </div>
                <div className="max-w-8xl  px-4 sm:px-6 lg:px-22 mx-auto pt-10 pb-24 bg-[#f4f4f4]">
                    <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                        ...
                        {/* <button className="flex items-center bg-[#3A3A3A] text-white  overflow-hidden hover:bg-black transition-colors group">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {/* Card 1 */}
                        <div className="bg-white  overflow-hidden shadow-sm flex flex-col relative group">
                            ...
                            {/* Bottom Green Line */}
                            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1/3 h-1.5 bg-[#5B9BD5]"></div>
                        </div>
