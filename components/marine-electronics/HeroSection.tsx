            ...
            <div className="relative w-full h-[550px] sm:h-[450px] md:h-auto md:aspect-21/9  overflow-hidden shadow-sm">
                ...
                <div className="absolute inset-0 z-20 flex items-center">
                    ...
                    <div className="w-full lg:w-[65%] pl-8 md:pl-16 lg:pl-24 flex flex-col justify-center relative z-30">
                        ...
                        >
                            에코트로닉스는 30년 이상 축적된 해양 전자 기술을 바탕으로 선박의 안전하고 효율적인 운항을 <br /> 지원하는 항해·통신·제어 전자장비를 개발·제조하고 있습니다. 레이더, 어군탐지기, 오토파일럿, <br /> 통합 디스플레이 등 고신뢰 해양 솔루션을 통해 글로벌 해양 산업의 기준을 만들어갑니다. <br />에코트로닉스의 Marine Electronics 기술은 실제 운항 환경을 고려한 설계와 검증을 <br /> 통해 레저선박부터 상업용 선박까지 폭넓게 적용되고 있습니다.
                        </motion.p>
                    </div>
                </div>
