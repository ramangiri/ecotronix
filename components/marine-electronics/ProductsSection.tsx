                        ...
                        >
                            ...
                            <div className="mb-8">
                                ...
                                <ul className="space-y-3 text-gray-600 font-light text-base md:text-lg leading-relaxed pl-10">
                                    <li className="flex items-start">
                                        ...
                                        레이더 플로터, 전자해도(ENC), 어군탐지기, 멀티빔 소나, AIS, GPS등의 정보를 한 화면에서 통합 표시
                                    </li>
                                    <li className="flex items-start">
                                        <span className="mr-2 mt-1.5 w-1.5 h-1.5 rounded-full bg-gray-400 shrink-0"></span>
                                        분할화면, 3~4분할 레이아웃, 사용자 지정 모드 지원 터치 + 하드키 + 노브 <br /> 조합으로 거친 해상 환경에서도 안정적인 조작 가능
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul className="space-y-3 text-gray-600 font-light text-base md:text-lg leading-relaxed pl-10">
                                    <li className="flex items-start">
                                        <span className="mr-2 mt-1.5 w-1.5 h-1.5 rounded-full bg-gray-400 shrink-0"></span>
                                        <span className="font-medium text-gray-700 mr-1 whitespace-nowrap">레저보트 :</span> 항로 계획(웨이포인트•루트), 어군 분포 표시, 수심지도 표시
                                    </li>
                                    <li className="flex items-start">
                                        <span className="mr-2 mt-1.5 w-1.5 h-1.5 rounded-full bg-gray-400 shrink-0"></span>
                                        <span className="font-medium text-gray-700 mr-1 whitespace-nowrap">연안어선 :</span> 조업 해역의 해저 지형(홈, 언덕, 암반)과 어군 밀집 지역을 한눈에 <br /> 파악하여 연료 사용량 대비 조업 효율을 극대화
                                    </li>
                                    <li className="flex items-start">
                                        <span className="mr-2 mt-1.5 w-1.5 h-1.5 rounded-full bg-gray-400 shrink-0"></span>
                                        <span className="font-medium text-gray-700 mr-1 whitespace-nowrap">작업선·관공선 :</span> 항만 및 수중 구조물, 등부표, 제한 수역 등을 표시하여 안전한 <br /> 접근과 작업 지원
                                    </li>
                                </ul>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="mb-8">
                                ...
                                <ul className="space-y-3 text-gray-600 font-light text-base md:text-lg leading-relaxed pl-10">
                                    ...
                                    <li className="flex items-start">
                                        <span className="mr-2 mt-1.5 w-1.5 h-1.5 rounded-full bg-gray-400 shrink-0"></span>
                                        선장이 원하는 시점에 Auto/Manual 전환 가능, 안전을 위한 우선 차단(override) 기능 지원
                                    </li>
                                    <li className="flex items-start">
                                        <span className="mr-2 mt-1.5 w-1.5 h-1.5 rounded-full bg-gray-400 shrink-0"></span>
                                        향후, 센서 데이터를 기반으로 “위험 선박 회피를 고려한 자동 경로 재설정” 기능 추가 예정
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul className="space-y-3 text-gray-600 font-light text-base md:text-lg leading-relaxed pl-10">
                                    <li className="flex items-start">
                                        <span className="mr-2 mt-1.5 w-1.5 h-1.5 rounded-full bg-gray-400 shrink-0"></span>
                                        <span className="font-medium text-gray-700 mr-1 whitespace-nowrap">연안 운항 :</span> 항로의 직선 구간에서는 AutoPilot가 자동으로 항로를 유지하고, <br /> 선장은 트래픽 감시와 조업에 집중
                                    </li>
                                    <li className="flex items-start">
                                        <span className="mr-2 mt-1.5 w-1.5 h-1.5 rounded-full bg-gray-400 shrink-0"></span>
                                        <span className="font-medium text-gray-700 mr-1 whitespace-nowrap">장거리 항해 :</span>
                                        피로를 줄이고 일정한 속력·코스를 유지하여 연료 효율 향상
                                    </li>
                                </ul>
                            </div>
                        </motion.div>
                ...
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start gap-16">
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        >
                            <div className="mb-8">
                                <h4 className="text-lg font-semibold text-gray-900 mb-3">기능</h4>
                                <ul className="space-y-3 text-gray-600 font-light text-base md:text-lg leading-relaxed pl-2">
                                    <li className="flex items-start">
                                        <span className="mr-2 mt-1.5 w-1.5 h-1.5 rounded-full bg-gray-400 shrink-0"></span>
                                        멀티빔 소나를 통해 고해상도 3D 해저 지형과 어군 분포를 실시간 시각화 PBG <br />(개인용 수심지도) 생성,
                                    </li>
                                    <li className="flex items-start">
                                        <span className="mr-2 mt-1.5 w-1.5 h-1.5 rounded-full bg-gray-400 shrink-0"></span>
                                        수심 음영지도, 등고선 지도 등 다양한 지도 모드 지원
                                    </li>
                                    <li className="flex items-start">
                                        <span className="mr-2 mt-1.5 w-1.5 h-1.5 rounded-full bg-gray-400 shrink-0"></span>
                                        어종·어군 크기 추정, 어군 레이어 깊이 표시 등 어획에 특화된 기능 사용 예시
                                    </li>
                                    <li className="flex items-start">
                                        <span className="mr-2 mt-1.5 w-1.5 h-1.5 rounded-full bg-gray-400 shrink-0"></span>
                                        <span className="font-medium text-gray-700 mr-1 whitespace-nowrap">근해 선망·트롤 :</span> 물때와 조류에 따라 이동하는 어군의 위치를 3D로 파악하여 <br /> 어획량을 극대화
                                    </li>
                                    <li className="flex items-start">
                                        <span className="mr-2 mt-1.5 w-1.5 h-1.5 rounded-full bg-gray-400 shrink-0"></span>
                                        <span className="font-medium text-gray-700 mr-1 whitespace-nowrap">레저 낚시 :</span> 인기 포인트 주변의 수중 지형을 저장하여, 다음 출항 시 개인 맞춤형 <br />포인트 지도로 재활용
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul className="space-y-3 text-gray-600 font-light text-base md:text-lg leading-relaxed pl-10">
                                    ...
                                    <li className="flex items-start">
                                        <span className="mr-2 mt-1.5 w-1.5 h-1.5 rounded-full bg-gray-400 shrink-0"></span>
                                        <span className="font-medium text-gray-700 mr-1 whitespace-nowrap">레저 낚시:</span> 인기 포인트 주변의 수중 지형을 저장하여, 다음 출항 시 개인 맞춤형 포인트 지도로 재활용
                                    </li>
                                </ul>
                            </div>
                        </motion.div>
