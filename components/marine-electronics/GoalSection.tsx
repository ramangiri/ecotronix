    ...
    return (
        <section id="goal" className="w-full max-w-[1920px] mx-auto px-4 md:px-8 py-20 md:py-32">
            <div className="max-w-7xl mx-auto relative flex flex-col lg:flex-row items-center">
                ...
                <div className="hidden desktop-block absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-32 z-0">
                    <motion.div
                        initial={{ scaleX: 0 }}
                ...
                <div className="w-full lg:w-1/2 lg:pl-16 mt-12 lg:mt-0 relative z-10">
                    <motion.div
                        ...
                        className="mb-8"
                    >
                        <h2 className="text-4xl md:text-5xl font-medium text-[#0078ff] inline-block border-b-[3px] border-[#0078ff] pb-3 px-1 tracking-tight">
                            목표
                        </h2>
                    </motion.div>
