                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex-shrink-0">
                            <Link
                                ...
                                className="flex items-center gap-2 text-[#0066ff]"
                            >
                                ...
                                <div key={link.name} className="relative group/nav-item h-full flex items-center">
                                    ...
                                    {link.name === "회사소개" && (
                                        <div className="absolute top-[100%] left-1/2 -translate-x-1/2 mt-4 opacity-0 pointer-events-none group-hover/nav-item:opacity-100 group-hover/nav-item:pointer-events-auto transition-all duration-300 w-[450px] lg:w-[500px] z-50">
                                            <div className="bg-white dark:bg-[#151515] border border-gray-200 dark:border-white/10 p-4 rounded-2xl shadow-xl flex flex-col gap-1 relative before:absolute before:-top-6 before:left-0 before:w-full before:h-6">
                                                {aboutSubMenu.map((item, idx) => (
                                                    <Link
                                                        key={idx}
                                                        href={item.href}
                                                        className="flex items-center gap-5 group/item p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 transition-colors"
                                                    >
                                                        <div className="flex-shrink-0 w-28 h-20 relative rounded-lg overflow-hidden border border-gray-100 dark:border-white/5">
                                                            <Image
                                                                src={item.image}
                                                                alt={item.title}
                                                                fill
                                                        ...
                                                        <div className="flex flex-col">
                                                            <h4 className="font-semibold text-[15px] text-gray-900 dark:text-white mb-1 group-hover/item:text-[#0066ff] transition-colors">
                                                                {item.title}
                                                            </h4>
                        ...
                        <div className="hidden md:flex items-center flex-shrink-0 gap-4">
                            <div className="relative group/lang flex items-center h-full">
                                <button className="flex items-center gap-1.5 text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-[#0066ff] transition-colors py-2">
                                ...
                                <div className="absolute top-[100%] left-1/2 -translate-x-1/2 mt-4 opacity-0 pointer-events-none group-hover/lang:opacity-100 group-hover/lang:pointer-events-auto transition-all duration-300 w-32 z-50">
                                    <div className="bg-white dark:bg-[#151515] border border-gray-200 dark:border-white/10 p-2 rounded-xl shadow-xl flex flex-col gap-1 relative before:absolute before:-top-6 before:left-0 before:w-full before:h-6">
                                        <button onClick={() => handleLocaleChange('ko')} className={cn("text-left px-3 py-2 text-sm rounded-lg hover:text-[#0066ff] cursor-pointer hover:bg-gray-50 dark:hover:bg-white/5 transition-colors", locale === 'ko' ? "text-[#0066ff] font-semibold" : "text-gray-700 dark:text-gray-300")}>Korean</button>
                                        <button onClick={() => handleLocaleChange('en')} className={cn("text-left px-3 py-2 text-sm rounded-lg hover:text-[#0066ff] cursor-pointer hover:bg-gray-50 dark:hover:bg-white/5 transition-colors", locale === 'en' ? "text-[#0066ff] font-semibold" : "text-gray-700 dark:text-gray-300")}>English</button>
                                        <button onClick={() => handleLocaleChange('ja')} className={cn("text-left px-3 py-2 text-sm rounded-lg hover:text-[#0066ff] cursor-pointer hover:bg-gray-50 dark:hover:bg-white/5 transition-colors", locale === 'ja' ? "text-[#0066ff] font-semibold" : "text-gray-700 dark:text-gray-300")}>Japanese</button>
                                    </div>
                                </div>
                            </div>
                            <button
                                onClick={() => setIsModalOpen(true)}
                                className="flex items-center bg-gradient-to-r from-blue-500 via-cyan-400 to-purple-600 text-white rounded p-1 shadow-md hover:shadow-lg transition-all group"
                            >
                                <span className="px-5 py-1.5 text-sm font-bold tracking-wide">문의하기</span>
                                <div className="bg-white text-gray-900 rounded-sm w-8 h-8 flex items-center justify-center group-hover:bg-gray-50 transition-colors">
                            ...
                            <div className="container px-4 py-4 space-y-4">
                                ...
                                <div className="pt-2 flex flex-col gap-4">
                                    <div className="flex items-center justify-center gap-2">
                                        <button onClick={() => handleLocaleChange('ko')} className={cn("px-3 py-1.5 text-sm rounded-md transition-colors", locale === 'ko' ? "bg-muted text-primary font-medium" : "text-muted-foreground")}>KR</button>
                                        <span className="text-muted-foreground/30">|</span>
                                        <button onClick={() => handleLocaleChange('en')} className={cn("px-3 py-1.5 text-sm rounded-md transition-colors", locale === 'en' ? "bg-muted text-primary font-medium" : "text-muted-foreground")}>EN</button>
                                        <span className="text-muted-foreground/30">|</span>
                                        <button onClick={() => handleLocaleChange('ja')} className={cn("px-3 py-1.5 text-sm rounded-md transition-colors", locale === 'ja' ? "bg-muted text-primary font-medium" : "text-muted-foreground")}>JP</button>
                                    </div>
                                    <button
                                        onClick={() => {
                                            setIsOpen(false);
                                        ...
                                        className="flex w-full items-center justify-center bg-gradient-to-r from-blue-500 via-cyan-400 to-purple-600 text-white rounded p-1 shadow-md hover:shadow-lg transition-all group"
                                    >
                                        <span className="px-5 py-1.5 text-sm font-bold tracking-wide">문의하기</span>
                                        <div className="bg-white text-gray-900 rounded-sm w-8 h-8 flex items-center justify-center group-hover:bg-gray-50 transition-colors">
                                            <ArrowUpRight className="w-4 h-4" />
