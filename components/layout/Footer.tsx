                    ...
                    >
                        ...
                        >
                            ...
                            <div className="p-8 pt-0 flex justify-end gap-4">
                                <button type="button" onClick={() => setIsModalOpen(false)} className="px-8 py-3  font-medium text-gray-500 hover:bg-gray-50 transition-colors">Cancel</button>
                                <button type="button" onClick={() => setIsModalOpen(false)} className="px-8 py-3  font-medium bg-[#1a1a1a] text-white hover:bg-black transition-colors shadow-sm tracking-wide">Submit</button>
                            </div>
                        </motion.div>
                    </motion.div>
                )}
