...
export function CustomerSupportSection() {
  return (
    <section id="customer_support" className="w-full bg-white pt-24 md:pt-32 pb-24 relative overflow-hidden">
      <div className="w-full max-w-[1920px] mx-auto px-4 md:px-8 lg:px-16 mb-16 md:mb-24">
        <div className="flex flex-col">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-4 h-1 bg-[#1e6eaa]"></div>
            <span className="text-sm font-bold tracking-widest text-gray-900 uppercase">CUSTOMER SUPPORT</span>
          </div>
          <h2 className="text-5xl md:text-5xl font-medium text-gray-900 tracking-tight">고객지원</h2>
        </div>
      </div>
