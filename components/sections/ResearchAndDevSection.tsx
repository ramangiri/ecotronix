      ...
      <div className="w-full max-w-[1920px] mx-auto px-4 md:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 md:mb-24 mx-auto">
          <div className="flex flex-col mb-8 md:mb-0">
            ...
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-medium text-gray-900 tracking-tight">연구개발</h2>
          </div>
        ...
        <div className=" mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 relative">
          ...
          <div className="flex flex-col relative z-20 justify-center min-h-[400px] lg:min-h-0 lg:h-full">
            ...
            <div className="hidden desktop-block absolute top-1/2 left-0 w-[calc(100%+6rem)] h-[1px] bg-gradient-to-r from-transparent to-gray-400 z-0">
          ...
          <div className="relative z-10">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
              className="relative aspect-5/3 rounded-xl overflow-hidden border border-gray-200 p-2 bg-white shadow-sm"
            >
              <img
                src={activeTab.image}
                alt={activeTab.title}
