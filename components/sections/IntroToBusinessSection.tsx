...
export function IntroToBusinessSection() {
    return (
        <section id="about" className="w-full max-w-[1920px] mx-auto px-4 md:px-8 lg:px-16 py-2 md:py-2">
            <div className='pb-15 pt-2'>
                <div className="flex items-center gap-4 mb-6">
                    <div className="w-4 h-1 bg-[#1e6eaa]"></div>
                    <span className="text-sm font-bold tracking-widest text-gray-900 dark:text-gray-100 uppercase">Corporate Profile</span>
                </div>
                <h2 className="text-4xl md:text-5xl font-medium text-gray-900 dark:text-white tracking-tight">회사소개</h2>
            </div>
                ...
                <div className="absolute inset-0 z-20 flex flex-col justify-center px-8 md:px-16 lg:px-24">
                    <div className="max-w-2xl">
                        ...
                        <p className="text-lg md:text-xl text-gray-200 font-light leading-relaxed mb-12 max-w-3xl">
                            에코트로닉스는 <span className="font-bold">30</span>년 이상 축적된 전자•제조 기술력을 기반으로 <br />
                            선박용 항해전자장비,<span className="font-bold">AI</span>  기반 스마트 솔루션, 글로벌 <span className="font-bold">EMS/ODM</span>등 <br />
                            다양한 산업 분야에서 고객의 가치를 제공하는 종합 기술 기업입니다

                        </p>

                        <Link href="/about">
                            <button className="relative flex items-center bg-linear-to-r from-[#4877b1] via-[#4877b1] to-[#89bdb4] text-white group hover:shadow-lg transition-all w-max p-1 overflow-hidden">
                                ...
                                <span className="relative px-8 py-3 text-sm font-bold tracking-wide group-hover:text-black transition-colors duration-300 z-10">상세페이지로</span>
                                <div className="relative bg-white text-gray-900 w-11 h-11 flex items-center justify-center z-10">
