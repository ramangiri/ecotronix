          ...
          <div className="mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-10">
            ...
            <div className="flex flex-col text-white ml-4 md:ml-8 border-l-4 border-gray-500 pl-4 py-1">
              ...
              <div className="flex flex-col gap-2.5 text-gray-200 text-sm md:text-base font-light">
                ...
                <p>"문의하기" 기 클릭하여 간단하게 입력해 주시기 바랍니다</p>
              </div>
            </div>
            ...
            <button
              ...
              className="relative flex items-center bg-white text-gray-900 p-1.5 hover:shadow-xl transition-all group shrink-0 mt-4 md:mt-0 overflow-hidden"
            >
              <div className="absolute inset-1.5 bg-black origin-right scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-out z-0"></div>
              <span className="relative px-8 py-3 text-base font-bold tracking-wide group-hover:text-white transition-colors duration-300 z-10">문의하기</span>
              <div className="relative bg-[#1a1a1a] text-white w-12 h-12 flex items-center justify-center group-hover:bg-black transition-colors z-10">
